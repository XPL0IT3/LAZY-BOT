...
// --- silent clear (tanpa output) ---
(() => {
  // Bersihin layar + scrollback, lalu pindah kursor ke pojok kiri-atas
  if (process.stdout && process.stdout.isTTY) {
    process.stdout.write("\x1b[2J"); // clear screen
    process.stdout.write("\x1b[3J"); // clear scrollback (xterm compatible)
...
// === LAZY BOT — banner solid (tanpa gradient, tanpa dependency) ===
(() => {
  const RESET = "\x1b[0m";
  const BOLD  = "\x1b[1m";
  // 90=gray, 91=red, 92=green, 93=yellow, 94=blue, 95=magenta, 96=cyan, 97=white
  const COLOR = "\x1b[96m"; // bright cyan (solid)
  ...
  // Cetak banner (baru ada output mulai di sini)
  console.log(
    "\n" +
